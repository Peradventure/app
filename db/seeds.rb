...
Situation.create(id: '26', title: 'Welcome', sit_rep: "This is the first page you see", choice_1: '1', choice_1_label: 'Wake Up', choice_2: '0', choice_2_label: 'Stay in the dream.' )
